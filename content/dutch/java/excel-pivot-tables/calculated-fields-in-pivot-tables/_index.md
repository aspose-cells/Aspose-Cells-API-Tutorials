...
description: Leer hoe u berekende velden in draaitabellen maakt met Aspose.Cells voor Java. Geef uw data-analyse een boost met aangepaste berekeningen in Excel.
type: docs
weight: 15
...
## Stap 1: Uw Java-project opzetten
 Maak eerst een nieuw Java-project in uw favoriete IDE en voeg de Aspose.Cells voor Java-bibliotheek toe. U kunt de bibliotheek downloaden van[hier](https://releases.aspose.com/cells/java/).
...
### Kan ik een berekend veld verwijderen als ik het niet langer nodig heb?
   Ja, u kunt een berekend veld uit de draaitabel verwijderen door naar het bestand te gaan`pivotFields` verzamelen en het veld op naam verwijderen.
