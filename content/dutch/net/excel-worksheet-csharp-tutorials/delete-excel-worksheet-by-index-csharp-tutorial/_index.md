---
title: Verwijder Excel-werkblad per index C # zelfstudie
linktitle: Verwijder Excel-werkblad per index
second_title: Aspose.Cells voor .NET API-referentie
description: Verwijder eenvoudig een specifiek Excel-werkblad met Aspose.Cells voor .NET. Gedetailleerde tutorial met codevoorbeelden.
type: docs
weight: 30
...
## Stap 4: Verwijder een werkblad per index
 ...
 Om een werkblad uit de index te verwijderen, kunt u de`RemoveAt()` werkwijze van de`Worksheets` voorwerp van de`Workbook` voorwerp. De index van het werkblad dat u wilt verwijderen, moet als parameter worden doorgegeven.
