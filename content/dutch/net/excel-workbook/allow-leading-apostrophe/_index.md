...
```
 ...
 Hier gebruiken we hulpprogrammamethoden`Get_SourceDirectory()` En`Get_OutputDirectory()` om onze bestandspaden gemakkelijk in te stellen. U kunt deze paden aanpassen aan uw directorystructuur.
