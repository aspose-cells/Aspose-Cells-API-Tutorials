...
1.  Aspose.Cells for Java: Ujistěte se, že máte nainstalovanou knihovnu Aspose.Cells for Java. Můžete si jej stáhnout z[tady](https://releases.aspose.com/cells/java/).
