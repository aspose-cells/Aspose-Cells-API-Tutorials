...
الآن بعد أن أصبح لدينا مصنف عمل، يمكننا إضافة بيانات إليه. يمكنك جلب البيانات من قاعدة بيانات أو واجهة برمجة تطبيقات أو أي مصدر آخر وتعبئتها في ورقة Excel الخاصة بك. على سبيل المثال:
...
إن مفتاح التقرير الديناميكي هو القدرة على تحديث البيانات تلقائيًا. يمكنك جدولة هذه العملية أو تشغيلها يدويًا. على سبيل المثال، يمكنك تحديث البيانات من قاعدة بيانات بشكل دوري أو عندما ينقر المستخدم على زر.
