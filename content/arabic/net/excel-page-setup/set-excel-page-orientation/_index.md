...
```
 ...
 هنا، استبدل`"YOUR DOCUMENT DIRECTORY"` مع المسار الفعلي على نظامك. فكر في الأمر كما لو كان بمثابة تحديد وجهة لرحلتك على الطريق.
...
في هذه الخطوة، ستضبط اتجاه الصفحة إلى الوضع الرأسي. وهنا يحدث السحر حقًا، وتتجسد تعديلاتك على أرض الواقع!
...
أخيرًا، حان الوقت لحفظ عملك. يجب عليك التأكد من كتابة جميع التغييرات التي أجريتها في ملف.
