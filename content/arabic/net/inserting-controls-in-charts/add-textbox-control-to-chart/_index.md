---
title: إضافة عنصر تحكم مربع نص إلى الرسم البياني
linktitle: إضافة عنصر تحكم مربع نص إلى الرسم البياني
second_title: واجهة برمجة تطبيقات معالجة Excel الخاصة بـ Aspose.Cells .NET
description: تعرف على كيفية إضافة مربع نص إلى المخططات في Excel باستخدام Aspose.Cells for .NET. قم بتعزيز تصور البيانات بسهولة.
type: docs
weight: 12
...
Aspose.Cells for .NET عبارة عن مكتبة فعالة لإنشاء ملفات Excel ومعالجتها وتحويلها دون الحاجة إلى الاعتماد على Microsoft Excel.
