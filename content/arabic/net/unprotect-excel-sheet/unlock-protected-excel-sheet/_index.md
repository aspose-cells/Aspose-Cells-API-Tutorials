...
```
 بفضل هذا، ستتلقى رسالة واضحة حول الخطأ الذي حدث، مما يجعل تصحيح الأخطاء أسهل كثيرًا. بالإضافة إلى ذلك،`Console.ReadLine()` سيبقي وحدة التحكم مفتوحة حتى تضغط على زر الإدخال، مما يتيح لك الوقت لقراءة الرسالة.
