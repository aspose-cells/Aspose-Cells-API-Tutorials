...
بمجرد إضافة المرجع، تأكد من استيراد المساحات الأساسية اللازمة في أعلى ملف الكود الخاص بك:
...
يجب عليك أولاً تحديد المكان الذي تريد حفظ ملف Excel فيه. وفيما يلي كيفية تحديد ذلك:
...
الأمر بسيط للغاية! الآن لديك مرجع للورقة الأولى التي ستقوم فيها بقفل الخلايا.
...
```
 ...
 من خلال الاتصال`Protect` بهذه الطريقة، فأنت تطلب من Excel منع أي تعديلات ما لم تتم إزالة الحماية.
...
بالتأكيد! يمكنك قفل عدد الخلايا الذي تريده عن طريق تكرار خطوات قفل الخلية لكل خلية مطلوبة.
