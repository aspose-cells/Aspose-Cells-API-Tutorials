...
قبل أن ننتقل إلى الترميز، تحتاج إلى استيراد المساحات الأساسية اللازمة. ستتيح لك هذه المساحات الأساسية الوصول إلى وظائف مكتبة Aspose.Cells.
...
بمجرد دمج الخلايا، قد نرغب في تطبيق بعض التنسيقات. فلنبدأ أولاً في استرداد النطاق المسمى.
