...
```
 هنا، نحن نستخدم طريقة`RunExamples.Get_OutputDirectory()` لتحديد المجلد الذي سيتم حفظ ملف Excel الناتج فيه. تأكد من تعريف هذه الطريقة في الكود الخاص بك لمعالجة الإخراج بشكل صحيح.
