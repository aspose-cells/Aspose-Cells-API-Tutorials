...
```
 ...
 في مقتطف التعليمات البرمجية هذا،`RunExamples.Get_SourceDirectory()` و`RunExamples.Get_OutputDirectory()` هي طرق تعيد المسارات إلى أدلة المصدر والإخراج على التوالي. تأكد من استبدال هذه الطرق بالمسارات الفعلية إذا كنت لا تستخدم هذه الطرق.
