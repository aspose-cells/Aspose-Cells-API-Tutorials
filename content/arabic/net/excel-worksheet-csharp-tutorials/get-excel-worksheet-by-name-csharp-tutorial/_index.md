...
4. ملف Excel: جهز ملف Excel الذي ترغب في العمل به. في مثالنا، سنستخدم ملفًا بسيطًا باسم`book1.xlsx` مع ورقة عمل واحدة على الأقل تسمى "Sheet1".
...
بعد ذلك، سنحتاج إلى إنشاء مجرى ملف. سيسمح لنا هذا المجرى بقراءة ملف Excel. فكر في الأمر كما لو كنت تفتح كتابًا حتى تتمكن من قراءة محتوياته.
