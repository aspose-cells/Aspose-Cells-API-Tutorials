...
---
## การแนะนำ
Pivot Table เป็นเครื่องมือที่มีประสิทธิภาพสำหรับการวิเคราะห์และสรุปข้อมูลใน Excel อย่างไรก็ตาม บางครั้งคุณจำเป็นต้องคำนวณข้อมูลภายใน Pivot Table เอง ในบทช่วยสอนนี้ เราจะแสดงวิธีการสร้างฟิลด์คำนวณใน Pivot Table โดยใช้ Aspose.Cells สำหรับ Java ซึ่งจะช่วยให้คุณวิเคราะห์ข้อมูลได้ดีขึ้น
...
### ฉันสามารถลบฟิลด์ที่คำนวณได้หากไม่ต้องการมันอีกต่อไปได้หรือไม่
   ใช่ คุณสามารถลบฟิลด์ที่คำนวณจากตารางสรุปข้อมูลได้โดยการเข้าถึง`pivotFields` การรวบรวมและการลบฟิลด์ตามชื่อ
