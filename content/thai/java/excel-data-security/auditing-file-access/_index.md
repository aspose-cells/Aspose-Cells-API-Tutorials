...
## ขั้นตอนที่ 4: การใช้ Audit Logger ในแอปพลิเคชันของคุณ
 ...
 ตอนนี้เราก็มีของเราแล้ว`FileAccessLogger` และ`ExcelFileManager` คลาสต่างๆ คุณสามารถนำไปใช้ในแอปพลิเคชันของคุณได้ดังนี้:
...
### ฉันสามารถบันทึกการกระทำอื่น ๆ อะไรได้บ้าง นอกจากการเปิดและบันทึกไฟล์?
 ...
 คุณสามารถขยายเวลาได้`ExcelFileManager` คลาสที่จะบันทึกการดำเนินการอื่น ๆ เช่น การแก้ไข การลบ หรือการแชร์ไฟล์ ขึ้นอยู่กับข้อกำหนดของแอปพลิเคชันของคุณ