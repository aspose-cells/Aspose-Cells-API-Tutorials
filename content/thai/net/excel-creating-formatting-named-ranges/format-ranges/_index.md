...
คำอธิบาย: บรรทัดนี้จะเริ่มการทำงาน`dataDir` ตัวแปร คุณควรแทนที่`"Your Document Directory"` ด้วยเส้นทางจริงบนเครื่องของคุณที่คุณต้องการบันทึกไฟล์ Excel ลองนึกถึงสิ่งนี้ว่าเป็นการกำหนดตำแหน่งที่ผลงานชิ้นเอกของคุณจะปรากฏ!
...
ถึงเวลาสร้างช่วงของเซลล์ที่เราต้องการจัดรูปแบบแล้ว ในขั้นตอนนี้ เราจะกำหนดจำนวนแถวและคอลัมน์ที่จะครอบคลุมช่วงของเซลล์

```csharp
Aspose.Cells.Range range = WS.Cells.CreateRange(1, 1, 5, 5); // สร้างช่วงตั้งแต่แถว 1 คอลัมน์ 1 ครอบคลุม 5 แถวและ 5 คอลัมน์
```
...
แม้ว่าจะไม่จำเป็น แต่การตั้งชื่อช่วงของคุณสามารถทำให้การอ้างอิงในภายหลังง่ายขึ้น โดยเฉพาะอย่างยิ่งหากสเปรดชีตของคุณมีความซับซ้อน
