...
## แพ็คเกจนำเข้า
หากต้องการใช้ Aspose.Cells ให้เต็มประสิทธิภาพ คุณจะต้องระบุเนมสเปซเฉพาะที่ด้านบนสุดของไฟล์ C# อย่าลืมเพิ่มสิ่งต่อไปนี้:
```csharp
using System;
using System.IO;
using Aspose.Cells;
...
```
ในขั้นตอนนี้ คุณกำลังสร้างเวิร์กบุ๊กที่สองซึ่งจะทำหน้าที่เป็นเป้าหมายของไฮเปอร์ลิงก์ของคุณ หากไม่มีขั้นตอนนี้ การคลิกลิงก์จะไม่นำไปสู่สิ่งใดเลย เหมือนกับการล็อกประตูที่ไม่มีกุญแจ!
