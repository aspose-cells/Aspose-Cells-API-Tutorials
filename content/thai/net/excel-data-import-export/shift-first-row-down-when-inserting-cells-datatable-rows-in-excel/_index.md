...
class CellsDataTable : ICellsDataTable
{
    ...
    // ... นำไปปฏิบัติร่วมกับสมาชิกท่านอื่น ...
}
```
...
## ขั้นตอนที่ 6: นำเข้า DataTable
 ...
 ตอนนี้เราสามารถนำเข้าข้อมูลจาก`CellsDataTable` ลงในแผ่นงาน
