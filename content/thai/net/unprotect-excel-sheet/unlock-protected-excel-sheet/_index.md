...
ก่อนจะเริ่มเขียนโค้ด สิ่งสำคัญคือต้องแน่ใจว่าคุณได้ตั้งค่าทุกอย่างเรียบร้อยแล้วสำหรับประสบการณ์การใช้งาน Aspose.Cells สำหรับ .NET ที่ราบรื่น:
...
เมื่อแผ่นงานได้รับการปกป้องแล้ว คุณต้องบันทึกการเปลี่ยนแปลงที่คุณได้ทำไว้ ซึ่งก็เหมือนกับการคลิก "บันทึก" หลังจากอ่านหรือแก้ไขเอกสาร
