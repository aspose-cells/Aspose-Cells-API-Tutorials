---
title: ปลดล็อกแผ่นงาน Excel ที่ได้รับการป้องกัน
linktitle: ปลดล็อกแผ่นงาน Excel ที่ได้รับการป้องกัน
second_title: Aspose.Cells สำหรับการอ้างอิง .NET API
description: เรียนรู้วิธีปลดล็อกสเปรดชีต Excel ที่มีการป้องกันโดยใช้ Aspose.Cells สำหรับ .NET บทช่วยสอนทีละขั้นตอนใน C#
type: docs
weight: 20
...
#### ถาม: ฉันจะทราบได้อย่างไรว่าสเปรดชีตมีการป้องกันด้วยรหัสผ่าน
 ...
 ตอบ: คุณสามารถตรวจสอบว่าแผ่นงานมีการป้องกันด้วยรหัสผ่านหรือไม่โดยใช้คุณสมบัติหรือวิธีการจากไลบรารี Aspose.Cells สำหรับ .NET ตัวอย่างเช่น คุณสามารถใช้`IsProtected()` วิธีการของวัตถุแผ่นงานเพื่อตรวจสอบสถานะการป้องกันของแผ่นงาน
