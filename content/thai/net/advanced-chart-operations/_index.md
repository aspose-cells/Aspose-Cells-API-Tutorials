...
## การใช้ Sparklines เพื่อรับข้อมูลเชิงลึกอย่างรวดเร็ว
 ...
 Sparklines คือแผนภูมิขนาดเล็กและน้ำหนักเบาที่ให้ข้อมูลสรุปแบบภาพเกี่ยวกับแนวโน้มข้อมูลอย่างรวดเร็ว Aspose.Cells สำหรับ .NET ช่วยให้คุณรวมแผนภูมิเหล่านี้เข้ากับเวิร์กบุ๊ก Excel ได้อย่างง่ายดาย เหมาะสำหรับทุกคนที่ต้องการเพิ่มการแสดงภาพข้อมูลเชิงลึกโดยไม่ทำให้แผ่นงานดูรก[ลองดูบทช่วยสอน](./using-sparklines/) สำหรับคำแนะนำทีละขั้นตอน
