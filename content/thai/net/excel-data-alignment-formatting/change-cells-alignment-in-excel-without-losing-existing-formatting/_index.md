...
ก่อนที่เราจะลงลึกในการเขียนโค้ดจริง สิ่งสำคัญคือต้องแน่ใจว่าคุณได้ตั้งค่าทุกอย่างอย่างถูกต้องแล้ว นี่คือสิ่งที่คุณต้องมี:
...
เปิด Visual Studio และสร้างโปรเจ็กต์ C# ใหม่ (แอปพลิเคชันคอนโซลจะทำงานได้ดี)
...
ในการเริ่มต้น คุณต้องกำหนดว่าจัดเก็บไฟล์ Excel ของคุณไว้ที่ไหน และต้องการบันทึกที่ใดหลังจากประมวลผล
