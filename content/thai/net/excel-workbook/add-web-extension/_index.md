...
```
 ที่นี่,`RunExamples.Get_OutputDirectory()` เป็นวิธีการที่ดึงข้อมูลเส้นทางไปยังไดเรกทอรีเอาต์พุต คุณสามารถปรับเปลี่ยนให้ชี้ไปยังตำแหน่งใดก็ได้ในระบบของคุณ
...
ขั้นตอนสุดท้ายของเราคือการบันทึกเวิร์กบุ๊ก ซึ่งตอนนี้รวมถึงส่วนขยายเว็บของเราด้วย
...
สุดท้ายให้พิมพ์ข้อความยืนยันไปยังคอนโซลเพื่อระบุว่าทุกอย่างเป็นไปอย่างราบรื่น
...
Aspose.Cells มีไว้สำหรับแอปพลิเคชัน .NET เป็นหลัก แต่ยังมีเวอร์ชันสำหรับ Java และภาษาอื่นๆ ด้วย
