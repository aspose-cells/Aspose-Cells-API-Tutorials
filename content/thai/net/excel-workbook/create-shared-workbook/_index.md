...
```
 ที่นี่เราใช้วิธีการ`RunExamples.Get_OutputDirectory()` เพื่อระบุโฟลเดอร์ที่จะบันทึกไฟล์ Excel ที่สร้างขึ้น ตรวจสอบให้แน่ใจว่าได้กำหนดวิธีนี้ไว้ในโค้ดของคุณแล้ว เพื่อการประมวลผลเอาต์พุตที่เหมาะสม
...
เพื่อยืนยันว่าทุกอย่างเป็นไปอย่างราบรื่น ให้เราพิมพ์ข้อความแสดงความสำเร็จ
...
ใช่ ต้องมีใบอนุญาตจึงจะใช้ Aspose.Cells ในเชิงพาณิชย์ได้ นอกจากนี้ คุณยังสามารถรับรุ่นทดลองใช้งานฟรีเพื่อทดสอบคุณสมบัติของมันได้อีกด้วย
