...
ตอนนี้ไดเร็กทอรีของคุณพร้อมแล้ว มาสร้างเวิร์กบุ๊ก Excel ใหม่กันเถอะ ซึ่งก็เหมือนกับการเริ่มวาดภาพบนผืนผ้าใบเปล่าๆ ก่อนเริ่มลงสี
...
เมื่อถึงจุดนี้ เราพร้อมที่จะกำหนดว่าคุณต้องการอนุญาตให้แก้ไขในช่วงใด มาสร้างช่วงนี้กัน
