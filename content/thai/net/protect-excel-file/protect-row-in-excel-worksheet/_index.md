...
```
 บรรทัดนี้จะเริ่มต้นอินสแตนซ์ใหม่ของ`Workbook` ชั้นเรียนกำลังสร้างเวิร์กชีตใหม่เพื่อให้เราได้ทำงาน
...
```csharp
sheet.Protect(ProtectionType.All); // ปกป้องแผ่นงานด้วยคุณสมบัติทั้งหมด
```
...
### ฉันจะได้รับการสนับสนุนสำหรับ Aspose.Cells ได้จากที่ไหน
 คุณสามารถเยี่ยมชม[ฟอรั่มสนับสนุน Aspose](https://forum.aspose.com/c/cells/9) เพื่อความช่วยเหลือและคำแนะนำชุมชน