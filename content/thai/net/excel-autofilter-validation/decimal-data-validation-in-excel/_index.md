...
ลองนึกถึงสมุดงานเป็นผืนผ้าใบเปล่าสำหรับข้อมูลของคุณ ณ จุดนี้ สมุดงานไม่มีเนื้อหาใดๆ แต่พร้อมที่จะลงสีแล้ว
...
ตอนนี้เรามาดึงคอลเลกชันการตรวจสอบความถูกต้องจากเวิร์กชีตกัน เนื่องจากเราจะจัดการกฎการตรวจสอบความถูกต้องของข้อมูลที่นี่:
...
ตอนนี้เราจะระบุเงื่อนไขสำหรับค่าที่อนุญาต เราต้องการให้แน่ใจว่าข้อมูลที่ป้อนเข้าไปนั้นอยู่ในช่วงสองช่วง:
