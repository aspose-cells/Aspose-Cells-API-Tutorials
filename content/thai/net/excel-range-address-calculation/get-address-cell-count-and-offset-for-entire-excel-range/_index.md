...
```
 การ`CreateRange`วิธีการสร้างช่วงที่เราระบุ คุณจะสังเกตเห็นว่าเราพิมพ์ข้อความไปยังคอนโซลเพื่อติดตามสิ่งที่เกิดขึ้น
...
ตอนนี้ถึงเวลาเจาะลึก Range A1 แล้ว นี่คือวิธีที่เราทำ:
```csharp
// สร้างช่วง A1.
