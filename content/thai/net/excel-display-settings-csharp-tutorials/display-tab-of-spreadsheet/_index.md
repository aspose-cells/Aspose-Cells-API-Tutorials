...
เมื่อกำหนดเส้นทางเรียบร้อยแล้ว เราต้องเปิดไฟล์ Excel ใน Aspose.Cells คุณสามารถจัดการไฟล์ Excel ผ่านทางออบเจ็กต์ Workbook ออบเจ็กต์นี้ประกอบด้วยเวิร์กชีต แผนภูมิ และการตั้งค่าทั้งหมดในไฟล์ Excel
...
ไม่ Aspose.Cells ไม่ต้องการ Microsoft Excel หรือซอฟต์แวร์อื่นใด มันทำงานอย่างอิสระ ซึ่งถือเป็นข้อดีที่ใหญ่ที่สุดข้อหนึ่ง
