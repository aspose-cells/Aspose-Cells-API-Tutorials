...
```
 ...
 บรรทัดนี้จะกำหนดขนาดกระดาษสำหรับเวิร์กชีตที่ระบุเป็น A4 คุณสามารถสลับเปลี่ยนได้อย่างง่ายดาย`PaperA4` พร้อมกระดาษขนาดอื่นๆ ให้เลือก`PaperSizeType` การนับ เช่น`PaperLetter` หรือ`PaperA3`.
