...
เรามาแบ่งขั้นตอนออกเป็นบทช่วยสอนทีละขั้นตอนที่ชัดเจนเพื่อให้คุณทำตามได้ง่าย พร้อมเริ่มหรือยัง เริ่มเลย!
...
## ขั้นตอนที่ 4: ตรวจสอบการตั้งค่าขนาดกระดาษ
 ...
 ตอนนี้มาถึงส่วนสนุกแล้ว! คุณจะต้องตรวจสอบว่าการตั้งค่าขนาดกระดาษของแต่ละเวิร์กชีตเป็นแบบอัตโนมัติหรือไม่ ซึ่งทำได้โดยตรวจสอบ`IsAutomaticPaperSize` ทรัพย์สินของ`PageSetup` คลาส ใช้โค้ดตัวอย่างต่อไปนี้:
