...
3. ไฟล์ Excel ตัวอย่าง: สำหรับการแนะนำการใช้งานนี้ คุณจะต้องมีไฟล์ Excel ตัวอย่างที่มีการตั้งค่าเครื่องพิมพ์ คุณสามารถสร้างไฟล์ดังกล่าวได้หรือใช้ไฟล์สาธิตที่ Aspose จัดเตรียมไว้ให้
...
```
 ...
 ที่นี่คุณจะแทนที่`RunExamples.Get_SourceDirectory()` และ`RunExamples.Get_OutputDirectory()` พร้อมเส้นทางจริงที่คุณเก็บไฟล์ไว้
