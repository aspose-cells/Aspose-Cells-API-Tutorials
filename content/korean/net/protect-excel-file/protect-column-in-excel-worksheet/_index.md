...
모든 코딩 모험과 마찬가지로 첫 번째 단계는 용품을 모으는 것입니다. 우리의 경우, Aspose.Cells 라이브러리를 프로젝트에 가져오는 것을 의미합니다. 방법은 다음과 같습니다.
...
```
 ...
 여기서 우리는 첫 번째 워크시트(색인)에 접근하고 있습니다.`0`). 워크시트는 각 페이지가 고유한 데이터를 갖고 있는 노트북의 개별 페이지로 생각할 수 있습니다.
