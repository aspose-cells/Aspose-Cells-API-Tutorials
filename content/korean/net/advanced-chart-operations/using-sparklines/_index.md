...
### 스파크라인이란?
스파크라인은 단일 셀에 맞춰진 소형 그래프로, 데이터 추세를 간결하고 간단하게 시각화해 보여줍니다.
