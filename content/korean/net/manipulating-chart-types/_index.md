...
### 파이 차트 수정
 파이 차트는 훌륭할 수 있지만 때로는 데이터를 더 잘 표현하기 위해 몇 가지 변경을 해야 합니다.[파이 차트 수정](./modify-pie-chart/) 튜토리얼에서는 파이 차트를 조정하여 데이터와 정확하게 일치시키는 방법을 배우게 됩니다. 슬라이스를 조정하거나 색상을 변경하거나 강조하기 위해 슬라이스를 폭발시켜야 할 수도 있습니다. 이 가이드에서 방법을 보여드리겠습니다!
