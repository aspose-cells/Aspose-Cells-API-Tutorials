...
## 1단계: 소스 디렉토리 정의
 ...
 여기서 Excel 파일이 있는 위치를 지정합니다. Aspose.Cells가 찾을 위치를 알 수 있도록 소스 디렉토리를 설정해 보겠습니다.`LinkTypes.xlsx`.
...
## 4단계: 범위 만들기
 ...
 이제 워크시트 내에서 범위를 정의하겠습니다. 범위를 사용하면 특정 셀을 작업 대상으로 지정할 수 있습니다. 이 경우 범위를 만듭니다.`A1` 에게`A7`하이퍼링크가 포함되어 있습니다.
