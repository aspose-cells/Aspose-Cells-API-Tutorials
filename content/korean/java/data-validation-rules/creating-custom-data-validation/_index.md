...
이제 사용자 지정 유효성 검사 기준을 정의했으니, 이를 특정 셀 범위에 적용해 보겠습니다.
...
### 같은 워크시트에서 여러 범위에 사용자 정의 데이터 유효성 검사를 적용할 수 있나요?
...
### 데이터 검증에 실패했을 때 표시되는 오류 메시지를 사용자 지정하려면 어떻게 해야 하나요?
 ...
 오류 메시지를 수정하여 사용자 정의할 수 있습니다.`setErrorMessage` 4단계의 방법에서는 검증 기준을 정의합니다.
