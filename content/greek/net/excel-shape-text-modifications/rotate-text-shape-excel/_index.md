...
2.  Aspose.Cells για .NET: Θα χρειαστείτε τη βιβλιοθήκη Aspose.Cells. Μπορείς[κατεβάστε την τελευταία έκδοση εδώ](https://releases.aspose.com/cells/net/) ή δοκιμάστε το δωρεάν με ένα[δωρεάν δοκιμή](https://releases.aspose.com/).
