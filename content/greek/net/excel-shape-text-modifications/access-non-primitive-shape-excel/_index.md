...
```
Αυτή η γραμμή έχει πρόσβαση στο πρώτο φύλλο εργασίας του βιβλίου εργασίας σας—Το Excel λειτουργεί καλύτερα όταν περιορίζουμε την εστίασή μας σε ένα φύλλο τη φορά.
