...
Εδώ έρχεται το κρίσιμο βήμα - η αποσύνδεση των κυττάρων! Θα θελήσετε να καθορίσετε το εύρος των συγχωνευμένων κελιών που θέλετε να καταργήσετε τη συγχώνευση. Χρησιμοποιήστε τον ακόλουθο κώδικα:
...
Το Aspose.Cells είναι μια ισχυρή βιβλιοθήκη για τη δημιουργία, το χειρισμό και τη μετατροπή εγγράφων Excel σε εφαρμογές .NET.
