...
2.  Aspose.Cells Library: Πρέπει να έχετε κατεβάσει τη βιβλιοθήκη Aspose.Cells και να την αναφέρετε στο έργο σας. Μπορείς[κατεβάστε τη βιβλιοθήκη εδώ](https://releases.aspose.com/cells/net/) αν δεν το έχετε κάνει ήδη.
