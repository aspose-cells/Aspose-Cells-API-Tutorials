...
1.  Aspose.Cells για .NET: Κάντε λήψη της βιβλιοθήκης από το[Aspose ιστότοπο](https://releases.aspose.com/cells/net/). Βεβαιωθείτε ότι έχετε την πιο πρόσφατη έκδοση για όλες τις νέες δυνατότητες και διορθώσεις σφαλμάτων.
...
## Βήμα 4: Ξεκλειδώστε όλες τις στήλες
...
### Υπάρχει τρόπος να ξεκλειδώσετε σειρές μετά την προστασία;
