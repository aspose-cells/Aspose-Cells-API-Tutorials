...
2.  Aspose.Cells για .NET: Πρέπει να έχετε κατεβάσει και ρυθμίσει τη βιβλιοθήκη Aspose.Cells για .NET. Μπορείς[κατεβάστε τη βιβλιοθήκη εδώ](https://releases.aspose.com/cells/net/).
