...
```
 ...
 Κάθε ένα από αυτά τα μπλοκ μιμείται το προηγούμενο βήμα αλλά προσαρμόζει το`PaperSize` ιδιοκτησίας ανάλογα. Αλλάζοντας απλώς την ένδειξη μεγέθους, λαμβάνετε διαφορετικές διαστάσεις χαρτιού χωρίς κόπο. Είναι σαν να αλλάζετε το μέγεθος ενός κουτιού με βάση το τι πρέπει να αποθηκεύσετε!
