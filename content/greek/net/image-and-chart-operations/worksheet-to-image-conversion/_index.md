...
2. Aspose.Cells for .NET Library: Πρέπει να αποκτήσετε αυτήν τη βιβλιοθήκη. Μπορείς[κατεβάστε το εδώ](https://releases.aspose.com/cells/net/) ή ξεκινήστε με α[δωρεάν δοκιμή](https://releases.aspose.com/).
