...
2.  Aspose.Cells για .NET: Πρέπει να κάνετε λήψη της βιβλιοθήκης Aspose.Cells και να προστεθεί στο έργο σας. Μπορείτε εύκολα να το αρπάξετε από το[Aspose ιστότοπο](https://releases.aspose.com/cells/net/).
