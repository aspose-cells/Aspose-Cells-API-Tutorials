...
Το πρώτο πράγμα που πρέπει να κάνουμε είναι να καθορίσουμε πού θα αποθηκευτεί το έγγραφό μας στο Excel. Μπορείτε να το ρυθμίσετε σε οποιαδήποτε διαδρομή στο τοπικό σας σύστημα. 
