...
2.  Aspose.Cells για .NET: Μπορείτε[κατεβάστε την πιο πρόσφατη έκδοση](https://releases.aspose.com/cells/net/) ή χρησιμοποιήστε τον διαχειριστή πακέτων NuGet για να το εγκαταστήσετε.
