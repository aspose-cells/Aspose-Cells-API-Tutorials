...
Η προσθήκη ετικετών απευθείας στα τμήματα του γραφήματος μπορεί να διευκολύνει την κατανόηση. Ας συμπεριλάβουμε τα ονόματα περιοχών και τις τιμές πωλήσεων στα τμήματα του γραφήματος πίτας.
