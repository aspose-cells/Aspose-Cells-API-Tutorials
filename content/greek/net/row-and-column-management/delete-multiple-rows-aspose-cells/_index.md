...
fstream.Close();
```
 Κλείσιμο του`fstream`εδώ ολοκληρώνεται ο κώδικας μας. Εάν η ροή αρχείων παραμένει ανοιχτή, μπορεί να εμποδίσει το πρόγραμμά σας να απελευθερώσει πόρους πίσω στο σύστημα, ειδικά όταν εργάζεστε με μεγάλα αρχεία.
## Σύναψη
