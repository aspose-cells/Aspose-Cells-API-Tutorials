...
2.  Aspose.Cells Library: Θα χρειαστείτε τη βιβλιοθήκη Aspose.Cells. Μπορείτε να το αποκτήσετε κατεβάζοντας από το[Aspose ιστότοπο](https://releases.aspose.com/cells/net/)Εναλλακτικά, μπορείτε να το εγκαταστήσετε απευθείας μέσω του NuGet στο Visual Studio.
