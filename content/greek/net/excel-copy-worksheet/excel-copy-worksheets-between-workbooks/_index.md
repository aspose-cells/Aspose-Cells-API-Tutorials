...
```
 ...
 Εδώ, φορτώνετε`book1.xls` (βεβαιωθείτε ότι το αρχείο υπάρχει στον κατάλογό σας) σε ένα νέο`Workbook` αντικείμενο που ονομάζεται`excelWorkbook0`. Αυτό είναι το βιβλίο εργασίας προέλευσης που περιέχει το φύλλο εργασίας που θα αντιγράψετε.
