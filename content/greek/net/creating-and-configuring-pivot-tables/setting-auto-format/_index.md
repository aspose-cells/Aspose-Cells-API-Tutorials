...
```
 Αυτή η γραμμή προετοιμάζει μια νέα`Workbook` αντικείμενο με τη φόρτωση του καθορισμένου αρχείου Excel. Το αρχείο θα πρέπει να περιέχει τουλάχιστον έναν συγκεντρωτικό πίνακα για να είναι αποτελεσματικά τα επόμενα βήματα.
