...
```
 Στιγμιοποιώντας το`Workbook` τάξη, ετοιμάζουμε ένα νέο βιβλίο εργασίας στη μνήμη. Σκεφτείτε αυτό ως άνοιγμα ενός νέου κενού φύλλου στο Excel, που περιμένει να συμπληρωθεί με δεδομένα.
