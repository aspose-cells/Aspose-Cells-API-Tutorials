...
### Είναι το Aspose.Cells για Java δωρεάν για χρήση;
 ...
 Όχι, το Aspose.Cells για Java είναι μια εμπορική βιβλιοθήκη με χρέωση άδειας χρήσης. Μπορείτε να επισκεφθείτε το[Aspose ιστότοπο](https://www.aspose.com/) για να μάθετε περισσότερα για τις τιμές τους.
