...
Ναι, το Aspose.Cells για Java είναι μια εμπορική βιβλιοθήκη και ίσως χρειαστεί να αποκτήσετε άδεια χρήσης για να το χρησιμοποιήσετε στις εφαρμογές σας. Επισκεφτείτε τον ιστότοπο Aspose για λεπτομέρειες αδειοδότησης.
