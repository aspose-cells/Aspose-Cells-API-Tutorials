...
L'étape suivante consiste à charger le classeur Excel contenant les objets OLE incorporés et les fichiers MOL. Voici le code pour charger le classeur :
...
## Étape 3 : Parcourez les feuilles et extrayez les fichiers MOL
...
## Conclusion
Félicitation ! Vous avez appris à extraire un fichier MOL intégré à partir d'un classeur Excel à l'aide d'Aspose.Cells pour .NET. Vous pouvez désormais appliquer ces connaissances pour extraire des fichiers MOL de vos propres classeurs Excel. N'hésitez pas à explorer davantage la bibliothèque Aspose.Cells et à découvrir ses autres fonctionnalités puissantes.

### FAQ

#### : Qu'est-ce qu'un fichier MOL ?
