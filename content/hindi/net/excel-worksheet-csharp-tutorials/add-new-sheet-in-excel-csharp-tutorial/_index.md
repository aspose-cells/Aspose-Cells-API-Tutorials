...
इससे पहले कि हम कोडिंग करें, आइए सुनिश्चित करें कि आपके पास इस परियोजना के लिए आवश्यक सभी चीजें मौजूद हैं:
...
### क्या मैं एक साथ कई शीट जोड़ सकता हूँ?  
 हाँ, बस फोन करें`Add()` विधि को कई बार उपयोग करें, और प्रत्येक शीट को उसके सूचकांक द्वारा संदर्भित करें!
