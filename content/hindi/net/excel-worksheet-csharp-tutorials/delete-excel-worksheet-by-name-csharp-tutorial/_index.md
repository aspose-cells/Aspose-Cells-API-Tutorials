---
title: एक्सेल वर्कशीट को सी# ट्यूटोरियल नाम से हटाएं
linktitle: एक्सेल वर्कशीट को नाम से हटाएं
second_title: .NET API संदर्भ के लिए Aspose.Cells
description: .NET के लिए Aspose.Cells का उपयोग करके किसी विशिष्ट Excel वर्कशीट को नाम से आसानी से हटाएं। कोड उदाहरणों के साथ विस्तृत ट्यूटोरियल।
type: docs
weight: 40
...
## चरण 4: वर्कशीट को नाम से हटाएं
 ...
 किसी वर्कशीट को उसके नाम से हटाने के लिए, आप इसका उपयोग कर सकते हैं`RemoveAt()` की विधि`Worksheets` की वस्तु`Workbook` वस्तु। जिस वर्कशीट को आप हटाना चाहते हैं उसका नाम एक पैरामीटर के रूप में पारित किया जाना चाहिए।
...
#### मुझे कैसे पता चलेगा कि कोई स्प्रेडशीट हटाने से पहले मौजूद है?
 ...
 किसी वर्कशीट को हटाने से पहले, आप इसका उपयोग करके जांच सकते हैं कि वह मौजूद है या नहीं`Contains()` की विधि`Worksheets` की वस्तु`Workbook` वस्तु। यह विधि स्प्रेडशीट नाम को एक पैरामीटर के रूप में लेती है और वापस लौटाती है`true` यदि स्प्रेडशीट मौजूद है, अन्यथा यह वापस आ जाती है`false`.
