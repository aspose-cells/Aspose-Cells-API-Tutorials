---
title: वर्कशीट की ग्रिडलाइन प्रदर्शित करें और छिपाएँ
linktitle: वर्कशीट की ग्रिडलाइन प्रदर्शित करें और छिपाएँ
second_title: .NET API संदर्भ के लिए Aspose.Cells
description: .NET के लिए Aspose.Cells के साथ एक्सेल वर्कशीट में ग्रिडलाइन्स के प्रदर्शन को नियंत्रित करें।
type: docs
weight: 30
url: /hi/net/excel-display-settings-csharp-tutorials/display-and-hide-gridlines-of-worksheet/
---
इस ट्यूटोरियल में, हम आपको दिखाएंगे कि .NET के लिए Aspose.Cells के साथ C# सोर्स कोड का उपयोग करके एक्सेल वर्कशीट में ग्रिडलाइन्स को कैसे दिखाया और छिपाया जाए। वांछित परिणाम प्राप्त करने के लिए नीचे दिए गए चरणों का पालन करें।
...
## चरण 3: पहली वर्कशीट पर जाएं और ग्रिडलाइन छुपाएं

 का उपयोग करके एक्सेल फ़ाइल में पहली वर्कशीट तक पहुंचें`Worksheets` की संपत्ति`Workbook` वस्तु। फिर उपयोग करें`IsGridlinesVisible` की संपत्ति`Worksheet` ग्रिडलाइन्स को छिपाने के लिए ऑब्जेक्ट।
...
### .NET के लिए Aspose.Cells का उपयोग करके वर्कशीट की ग्रिडलाइन्स को प्रदर्शित करने और छिपाने के लिए नमूना स्रोत कोड 
...
इस चरण-दर-चरण मार्गदर्शिका ने आपको दिखाया कि .NET के लिए Aspose.Cells का उपयोग करके एक्सेल स्प्रेडशीट में ग्रिडलाइन्स को कैसे दिखाया और छिपाया जाए। दिए गए C# स्रोत कोड का उपयोग करके, आप अपनी एक्सेल फ़ाइलों में ग्रिडलाइन्स के प्रदर्शन को आसानी से अनुकूलित कर सकते हैं।
...
#### मैं .NET के लिए Aspose.Cells के साथ एक्सेल स्प्रेडशीट में ग्रिडलाइन्स कैसे दिखा या छिपा सकता हूँ?

 आप इसका उपयोग कर सकते हैं`IsGridlinesVisible` की संपत्ति`Worksheet` ग्रिडलाइन दिखाने या छिपाने के लिए ऑब्जेक्ट। इसे सेट करें`true` उन्हें दिखाने के लिए और करने के लिए`false` उन्हें छुपाने के लिए.
