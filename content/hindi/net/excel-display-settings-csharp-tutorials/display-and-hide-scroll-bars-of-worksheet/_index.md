...
description: .NET के लिए Aspose.Cells का उपयोग करके एक्सेल वर्कशीट में स्क्रॉल बार प्रदर्शित करें या छिपाएँ।
type: docs
weight: 50
url: /hi/net/excel-display-settings-csharp-tutorials/display-and-hide-scroll-bars-of-worksheet/
---
इस ट्यूटोरियल में, हम आपको दिखाएंगे कि .NET के लिए Aspose.Cells के साथ C# स्रोत कोड का उपयोग करके Excel वर्कशीट में लंबवत और क्षैतिज स्क्रॉल बार को कैसे प्रदर्शित या छिपाया जाए। वांछित परिणाम प्राप्त करने के लिए नीचे दिए गए चरणों का पालन करें।
...
## चरण 3: स्क्रॉलबार छिपाएँ

 उपयोग`IsVScrollBarVisible` और`IsHScrollBarVisible` के गुण`Workbook.Settings` वर्कशीट के ऊर्ध्वाधर और क्षैतिज स्क्रॉलबार को छिपाने के लिए ऑब्जेक्ट।
...
### .NET के लिए Aspose.Cells का उपयोग करके वर्कशीट के स्क्रॉल बार्स को प्रदर्शित करने और छिपाने के लिए नमूना स्रोत कोड 
...
workbook.Settings.IsVScrollBarVisible = false;
// एक्सेल फ़ाइल की क्षैतिज स्क्रॉल पट्टी को छिपाना
workbook.Settings.IsHScrollBarVisible = false;
...
इस चरण-दर-चरण मार्गदर्शिका ने आपको दिखाया कि .NET के लिए Aspose.Cells का उपयोग करके Excel स्प्रेडशीट में लंबवत और क्षैतिज स्क्रॉल बार को कैसे प्रदर्शित या छिपाया जाए। दिए गए C# स्रोत कोड का उपयोग करके, आप अपनी Excel फ़ाइलों में स्क्रॉलबार के प्रदर्शन को आसानी से अनुकूलित कर सकते हैं।
...
#### मैं .NET के लिए Aspose.Cells के साथ Excel स्प्रेडशीट में स्क्रॉलबार कैसे प्रदर्शित या छिपा सकता हूँ?

 आप इसका उपयोग कर सकते हैं`IsVScrollBarVisible` और`IsHScrollBarVisible` के गुण`Workbook.Settings` एक्सेल वर्कशीट में क्रमशः ऊर्ध्वाधर और क्षैतिज स्क्रॉल बार को प्रदर्शित करने या छिपाने के लिए ऑब्जेक्ट।
