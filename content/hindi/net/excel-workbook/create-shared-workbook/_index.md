...
```
 यहाँ, हम एक विधि का उपयोग कर रहे हैं`RunExamples.Get_OutputDirectory()` उस फ़ोल्डर को निर्दिष्ट करने के लिए जहाँ जेनरेट की गई एक्सेल फ़ाइल सहेजी जाएगी। सुनिश्चित करें कि उचित आउटपुट प्रोसेसिंग के लिए यह विधि आपके कोड में परिभाषित है।
...
```
 तत्कालीकरण करके`Workbook` क्लास में, हम मेमोरी में एक नई वर्कबुक तैयार करते हैं। इसे एक्सेल में एक नई खाली शीट खोलने के रूप में सोचें, जो डेटा से भरने का इंतज़ार कर रही है।
...
### क्या मैं किसी कार्यपुस्तिका को साझा करने के बाद उसे वापस साझा कर सकता हूँ?
