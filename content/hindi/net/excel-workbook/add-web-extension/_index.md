...
```
 यहाँ,`RunExamples.Get_OutputDirectory()` यह एक विधि है जो आउटपुट निर्देशिका का पथ प्राप्त करती है। आप इसे अपने सिस्टम पर किसी भी स्थान पर इंगित करने के लिए संशोधित कर सकते हैं।
...
```
 यहाँ, हम कार्यपुस्तिका को उस आउटपुट निर्देशिका में सहेजते हैं जिसे हमने पहले निर्दिष्ट किया था।`"AddWebExtension_Out.xlsx"` जो भी फ़ाइल नाम आप चाहें, उसका उपयोग करें।
