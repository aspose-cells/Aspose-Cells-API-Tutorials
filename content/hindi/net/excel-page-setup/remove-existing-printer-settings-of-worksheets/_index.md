...
इससे पहले कि हम उन कष्टप्रद प्रिंटर सेटिंग्स को हटाना शुरू करें, आपको कुछ चीजों की आवश्यकता होगी। यह सुनिश्चित करने के लिए कि आप तैयार हैं, यहाँ एक त्वरित चेकलिस्ट दी गई है:
...
```
 ...
 यहाँ, आप प्रतिस्थापित करेंगे`RunExamples.Get_SourceDirectory()` और`RunExamples.Get_OutputDirectory()` वास्तविक पथ के साथ जहां आपकी फ़ाइलें संग्रहीत हैं.
