...
## पैकेज आयात करें
अब जब आपके पास अपनी पूर्व-आवश्यकताएं हैं, तो आरंभ करने के लिए अपने C# प्रोजेक्ट में आवश्यक पैकेजों को आयात करने का समय आ गया है।
...
अब, आपको उस विशिष्ट सेल का चयन करना होगा जिसके उदाहरणों का आप पता लगाना चाहते हैं। इस मामले में, हम सेल B4 चुनेंगे।
```csharp
Cell cell = cells["B4"];
```
