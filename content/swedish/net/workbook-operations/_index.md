...
## Få OData-detaljer från arbetsboken
...
Lär dig hur du implementerar XAdES-signaturstöd i Excel-arbetsböcker med Aspose.Cells för .NET. Följ vår steg-för-steg-guide för säker dokumentsignering.