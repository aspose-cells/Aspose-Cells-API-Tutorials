...
1. Visual Studio: Visual Studio должен быть установлен на вашем компьютере. Если у вас его еще нет, вы можете загрузить его с[веб-сайт Майкрософт](https://visualstudio.microsoft.com/).
