...
3. Базовые знания C#: хотя мы и будем объяснять все шаг за шагом, наличие фундаментальных знаний программирования на C# позволит вам лучше понять концепции.
...
Этот шаг можно сравнить с проверкой инструментов перед началом проекта.
