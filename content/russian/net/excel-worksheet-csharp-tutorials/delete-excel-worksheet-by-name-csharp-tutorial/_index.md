...
И вот оно! Вы успешно узнали, как удалить лист Excel по имени с помощью Aspose.Cells для .NET. Эта мощная библиотека позволяет вам без усилий манипулировать файлами Excel, и с этими знаниями вы можете глубже изучить редактирование и управление документами Excel для различных приложений.
