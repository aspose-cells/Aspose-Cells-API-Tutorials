...
### Могу ли я использовать Aspose.Cells бесплатно?
 Aspose предлагает бесплатную пробную версию, к которой вы можете получить доступ[здесь](https://releases.aspose.com/), что позволяет вам протестировать его возможности.
