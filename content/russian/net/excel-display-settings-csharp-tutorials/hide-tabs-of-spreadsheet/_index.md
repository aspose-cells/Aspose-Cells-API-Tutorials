...
### Как просмотреть скрытые вкладки в Excel?  
 Вы можете переключить`ShowTabs` свойство обратно в`true` используйте ту же структуру кода, если вам необходимо выполнить предварительный просмотр или восстановление вкладок.
