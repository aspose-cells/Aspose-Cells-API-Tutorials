...
Представьте, что у вас есть огромная электронная таблица с сотнями строк. Ручной расчет промежуточных итогов звучит устрашающе, не так ли? Но с Aspose.Cells для .NET это проще простого. В этом руководстве вы узнаете, как программно создавать промежуточные итоги в Excel. Зачем тратить время на повторяющиеся задачи, если несколько строк кода могут сделать это за вас? К концу этого руководства вы настроите свои промежуточные итоги в кратчайшие сроки.  
[Создание промежуточных итогов в Excel](./create-subtotals-in-excel/)
