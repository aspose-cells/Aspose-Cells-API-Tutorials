...
Установка пароля для защищенного диапазона гарантирует, что только те, у кого есть пароль, смогут изменять определенную область. Этот шаг повышает безопасность вашей электронной таблицы.
