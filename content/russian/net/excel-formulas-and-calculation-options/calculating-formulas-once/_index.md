...
2.  Aspose.Cells для .NET: Вам нужно будет скачать и установить библиотеку Aspose.Cells. Вы можете взять ее здесь[эта ссылка](https://releases.aspose.com/cells/net/). 
