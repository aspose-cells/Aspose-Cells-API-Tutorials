...
После добавления запустите свой проект. Вы должны увидеть имена соединений вместе с соответствующими им элементами, четко напечатанными в консоли.
...
Aspose.Cells — это библиотека .NET, которая позволяет разработчикам создавать, обрабатывать и конвертировать документы Excel без необходимости использования Microsoft Excel.
