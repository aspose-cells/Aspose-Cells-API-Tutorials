...
description: Уменьшите размер книг Excel, отрегулировав уровень сжатия с помощью Aspose.Cells для .NET.
type: docs
weight: 50
...
Загружаем книгу Excel из указанного файла с помощью`Workbook` класс из Aspose.Cells.
...
```
 ...
 Мы создаем экземпляр`XlsbSaveOptions` class для установки параметров сохранения.
