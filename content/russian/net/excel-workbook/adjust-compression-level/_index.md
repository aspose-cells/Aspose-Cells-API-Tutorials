...
```
 ...
 Здесь,`RunExamples.Get_SourceDirectory()` и`RunExamples.Get_OutputDirectory()` — это методы, которые возвращают пути к исходному и выходному каталогам соответственно. 
