...
Эти пакеты предоставляют нам доступ к классам и методам, предоставляемым Aspose.Cells, что позволяет нам эффективно манипулировать файлами Excel.
...
```
 ...
 Здесь мы создаем новый экземпляр`Workbook` class, передавая путь исходного файла в конструктор. Это загружает ваш файл Excel и делает его готовым к редактированию!
