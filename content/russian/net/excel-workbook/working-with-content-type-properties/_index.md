...
2.  Библиотека Aspose.Cells: последнюю версию можно загрузить с сайта[Страница загрузки Aspose.Cells](https://releases.aspose.com/cells/net/). Установите его через NuGet или вручную добавьте ссылку на свой проект.
...
```
 ...
 Здесь,`RunExamples.Get_OutputDirectory()` — это вызов функции, который извлекает назначенный путь для выходных файлов. Убедитесь, что этот метод определен и указывает на допустимый каталог.
