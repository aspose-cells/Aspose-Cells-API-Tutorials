...
Хотя руководство призвано провести вас через каждый шаг, наличие базовых знаний C# облегчит понимание представленных концепций.
...
Теперь пора сортировать! Для этого мы будем использовать класс DataSorter. Создадим ключ для сортировки на основе нашего пользовательского списка и выполним операцию сортировки.
