...
После снятия защиты с вашего рабочего листа последний шаг — сохранить изменения обратно в файл. Вы можете сохранить его как новый файл или перезаписать исходный.
