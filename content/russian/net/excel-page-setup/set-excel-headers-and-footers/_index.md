---
title: Установите верхние и нижние колонтитулы Excel
linktitle: Установите верхние и нижние колонтитулы Excel
second_title: Справочник по API Aspose.Cells для .NET
description: Узнайте, как настроить верхние и нижние колонтитулы в Excel с помощью Aspose.Cells для .NET.
type: docs
weight: 100
...
## Шаг 5: Настройка заголовков
 ...
 Установите заголовки электронной таблицы, используя`SetHeader` методы объекта PageSetup. Вот пример кода:
...
## Шаг 6: Определение нижних колонтитулов
 ...
 Установите нижние колонтитулы таблицы с помощью`SetFooter` методы объекта PageSetup. Вот пример кода:
...
Чтобы установить Aspose.Cells for .NET, вам необходимо загрузить установочный пакет с официального сайта Aspose и следовать инструкциям, приведенным в документации.
...
#### 5. Могу ли я удалить верхние и нижние колонтитулы после их настройки?
