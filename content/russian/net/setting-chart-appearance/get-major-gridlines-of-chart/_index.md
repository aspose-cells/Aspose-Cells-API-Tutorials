...
## Шаг 9: Покажите основные линии сетки
...
Эти две строки позволят пользователям легко читать и интерпретировать данные, предлагая визуальные указания по соотношению значений. 
