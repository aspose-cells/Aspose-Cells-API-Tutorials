...
Пояснение: Здесь мы заполняем ячейки "A1" по "A3" и "B1" по "B3" некоторыми числовыми значениями. Они будут нанесены на нашу диаграмму позже.
...
А теперь самое интересное — настройка диаграммы! Давайте изменим цвета.
