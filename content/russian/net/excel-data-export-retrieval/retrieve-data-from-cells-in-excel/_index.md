...
```
 ...
 На этом этапе мы проходим по каждой ячейке рабочего листа. Для каждой ячейки мы проверяем ее тип данных с помощью`switch` оператор. В зависимости от типа мы извлекаем значение и выводим его на консоль. Вот разбивка случаев:
