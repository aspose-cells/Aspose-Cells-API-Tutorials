...
## Фильтрация данных
Фильтрация данных позволяет отображать только те строки, которые соответствуют определенным критериям. Aspose.Cells предоставляет способ применения автофильтров к данным Excel. Вот как применять фильтры:
