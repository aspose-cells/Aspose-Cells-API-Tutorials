...
description: Узнайте, как экспортировать Excel в HTML в Java с помощью Aspose.Cells для Java. Следуйте этому пошаговому руководству с исходным кодом, чтобы легко преобразовать файлы Excel в HTML без усилий.
type: docs
weight: 19
...
### В: Существуют ли какие-либо лицензионные требования для использования Aspose.Cells для Java?
   - A: Да, Aspose.Cells требует действующую лицензию для производственного использования. Вы можете получить лицензию на сайте Aspose.
