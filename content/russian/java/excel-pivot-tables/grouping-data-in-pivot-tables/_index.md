...
## Шаг 2: Групповые данные
 ...
 В Aspose.Cells for Java вы можете группировать данные в сводной таблице, используя`PivotField` сорт. Вот пример того, как сгруппировать поле в сводной таблице:
