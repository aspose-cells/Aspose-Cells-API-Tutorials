...
description: Узнайте, как создавать вычисляемые поля в сводных таблицах с помощью Aspose.Cells для Java. Улучшите анализ данных с помощью пользовательских расчетов в Excel.
type: docs
weight: 15
...
## Шаг 1. Настройка вашего Java-проекта
 Сначала создайте новый проект Java в вашей любимой IDE и включите библиотеку Aspose.Cells для Java. Вы можете скачать библиотеку с[здесь](https://releases.aspose.com/cells/java/).
...
### Могу ли я удалить вычисляемое поле, если оно мне больше не нужно?
   Да, вы можете удалить вычисляемое поле из сводной таблицы, открыв`pivotFields` сбор и удаление поля по имени.
