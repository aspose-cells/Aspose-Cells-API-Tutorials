...
Вы можете предоставить сообщение о проверке и предупреждение об ошибке, чтобы направлять пользователей, когда они вводят данные, которые не соответствуют критериям. Вот как это можно сделать:
