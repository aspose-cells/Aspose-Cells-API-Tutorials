...
Ora che abbiamo aggiunto i fogli di lavoro, dobbiamo accedervi per poter modificare le loro impostazioni. Accederemo ai fogli di lavoro "TestSheet1" e "TestSheet2" usando i loro nomi. Ecco il codice per accedervi:
...
## Passaggio 4: impostazione del formato carta
 In questo passaggio, imposteremo le dimensioni della carta del foglio di lavoro "TestSheet1". Useremo il`PageSetup.PaperSize` proprietà per impostare il formato della carta. Ad esempio, imposteremo il formato carta su "PaperA3ExtraTransverse". Ecco il codice per questo:
...
## Passaggio 6: stampa dei formati della carta
 Dopo aver copiato le impostazioni di configurazione della pagina, stamperemo i formati carta dei due fogli di lavoro. Noi useremo`Console.WriteLine` per visualizzare i formati carta. Ecco il codice per questo:
...
Worksheet TestSheet1 = wb.Worksheets["TestSheet1"];
Worksheet TestSheet2 = wb.Worksheets["TestSheet2"];
//Impostare il formato carta di TestSheet1 su PaperA3ExtraTransverse
TestSheet1.PageSetup.PaperSize = PaperSizeType.PaperA3ExtraTransverse;
...
## Conclusione
In questo articolo, abbiamo imparato come copiare le impostazioni di configurazione della pagina da un foglio di lavoro a un altro utilizzando Aspose.Cells per .NET. Abbiamo eseguito i seguenti passaggi: creazione della cartella di lavoro, aggiunta di fogli di lavoro di prova, accesso ai fogli di lavoro, impostazione del formato carta, copia delle impostazioni di configurazione della pagina e stampa dei formati carta. Ora puoi usare questa conoscenza per copiare le impostazioni di configurazione della pagina nei tuoi progetti.
