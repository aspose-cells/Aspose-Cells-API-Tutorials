---
title: Aggiungi un foglio di lavoro Excel alla cartella di lavoro esistente C# Tutorial
linktitle: Aggiungi un foglio di lavoro Excel alla cartella di lavoro esistente
...
## Passaggio 4: aggiungi un nuovo foglio alla cartella di lavoro
 ...
 Per aggiungere un nuovo foglio di lavoro alla cartella di lavoro, è possibile utilizzare il file`Worksheets.Add()` metodo del`Workbook` oggetto. Questo metodo restituisce l'indice del foglio appena aggiunto.

```csharp
// Aggiungi un nuovo foglio alla cartella di lavoro Cartella di lavoro
int i = workbook. Worksheets. Add();
```

## Passaggio 5: imposta il nuovo nome del foglio

 È possibile impostare il nome del foglio appena aggiunto utilizzando il comando`Name` proprietà del`Worksheet` oggetto.

```csharp
// Ottenere il riferimento del nuovo foglio aggiunto passando il suo indice del foglio
...
### Codice sorgente di esempio per aggiungere un foglio di lavoro Excel alla cartella di lavoro esistente C# Tutorial utilizzando Aspose.Cells per .NET 
```csharp
//Il percorso della directory dei documenti.
string dataDir = "YOUR DOCUMENT DIRECTORY";
...
In questo tutorial abbiamo trattato il processo passo passo per aggiungere un nuovo fuoco Connect a una cartella di lavoro Excel esistente utilizzando Aspose.Cells per .NET. Seguendo gli esempi di codice e le spiegazioni fornite, ora dovresti avere una buona conoscenza di come eseguire questa attività nelle tue applicazioni C#. Aspose.Cells per .NET offre un set completo di funzionalità per lavorare con file Excel, consentendo di automatizzare in modo efficiente varie attività relative a Excel.

### Domande frequenti (FAQ)

#### Cos'è Aspose.Cells per .NET?

Aspose.Cells for .NET è una potente libreria .NET che consente agli sviluppatori di creare, manipolare e convertire file Excel nelle loro applicazioni. Offre un'ampia gamma di funzionalità per lavorare con fogli di calcolo, celle, formule, stili e altro ancora.
...
Aspose.Cells per .NET offre diversi metodi e proprietà per formattare le celle in un file Excel. Puoi impostare i valori delle celle, applicare opzioni di formattazione come stile del carattere, colore, allineamento, bordi e altro. Consulta la documentazione e il codice di esempio forniti da Aspose.Cells per informazioni più dettagliate sulla formattazione delle celle.
