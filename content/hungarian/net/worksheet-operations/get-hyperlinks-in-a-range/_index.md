...
// Kimeneti könyvtár
string outputDir = RunExamples.Get_OutputDirectory(); // Győződjön meg arról, hogy ez a módszer érvényes kimeneti útvonalat biztosít
```
...
```
 A`Hyperlinks` tulajdona a`Range`objektum egy tömböt ad vissza`Hyperlink` az adott tartományban található objektumok. Ez olyan, mintha egy mozdulattal lefoglalná az összes fontos jegyzetet az oldaláról!
