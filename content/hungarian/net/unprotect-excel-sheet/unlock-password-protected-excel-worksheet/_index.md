...
```
 ...
 Ha a munkalapja jelszóval védett, és ismeri a jelszót, akkor az üres karakterláncot le kell cserélnie`""` tényleges jelszóval. Ha nem ismeri, hagyja üresen, és futtassa, hogy ellenőrizze, működik-e.
