...
Tải bảng tính Excel của bạn
 ...
 Bước này bao gồm việc tạo ra một phiên bản của`Workbook` lớp, biểu thị tệp ODS của bạn. Sổ làm việc sẽ chứa tất cả các bảng tính và biểu đồ tương ứng của chúng.
