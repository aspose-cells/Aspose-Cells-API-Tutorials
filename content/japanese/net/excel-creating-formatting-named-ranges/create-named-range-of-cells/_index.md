...
ここでは、セル B4 から G14 までの長方形領域を指定しています。これが名前を付ける範囲です。

## ステップ5: 名前付き範囲の名前を設定する

範囲を定義したら、名前を割り当てることができます。これは、後で数式や関数でこの範囲を参照する方法です。
...
### つの Excel ワークシートに複数の名前付き範囲を作成できますか?
...
豊富なドキュメントと例については、[Aspose.Cells ドキュメント ページ](https://reference.aspose.com/cells/net/).