---
title: Déverrouiller la feuille de calcul Excel protégée par mot de passe
linktitle: Déverrouiller la feuille de calcul Excel protégée par mot de passe
second_title: Référence de l'API Aspose.Cells pour .NET
description: Découvrez comment déverrouiller une feuille de calcul Excel protégée par mot de passe à l'aide d'Aspose.Cells pour .NET. Tutoriel pas à pas en C#.
type: docs
weight: 10
...
### Exemple de code source pour déverrouiller la feuille de calcul Excel protégée par mot de passe à l'aide d'Aspose.Cells pour .NET 
```csharp
try
{
    // Chemin d'accès au répertoire des documents.
...
#### Q : Que se passe-t-il si la feuille de calcul est protégée par un mot de passe ?

 R : Si la feuille de calcul est protégée par un mot de passe, vous devez fournir le mot de passe approprié dans le`Unprotect()` méthode pour pouvoir le déverrouiller.
